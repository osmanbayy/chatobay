...
export const useChatStore = create((set, get) => ({
  ...
  isSoundsEnabled: localStorage.getItem("isSoundEnabled") === true,

  toggleSound: () => {
    localStorage.setItem("isSoundEnabled", get().isSoundsEnabled);
    set({ isSoundsEnabled: !get().isSoundsEnabled });
  },
